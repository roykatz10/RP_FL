    ...
    def train_admm(self, trainloader, z, epochs = 1):
        ...
        for e in range(epochs):
            for images, labels in trainloader:
                ...
                loss = self.admm_loss(out, labels, z, self.rho)
                loss.backward()
                opt.step()
        return loss
        

    def admm_loss(self, out, label, z, rho):
...
class ADMM_FlowerClient(FlowerClient):
    ...
    # TODO: reimplement this to give something that works for ADMM
    ...
    def fit(self, parameters, config):
        ...
        self.train_admm(config, state_dict)

        return self.get_parameters({}), len(self.trainloader), {}

    def train_admm(self, config, z, until_convergence = False, t = 0, max_epochs = 100):
        ...
        while (error > t) and (lepochs < max_epochs):
            self.net.train_admm(self.trainloader, z, epochs = 1)
